...
class Order extends Component {
    ...
    handlePayment = async () => {
        ...
        let totalPrice = this.props.book ? (this.props.total + this.state.transportFee + this.state.VAT) : this.props.total
        let date = new Date();
        ...
        let orderCode = ("0" + date.getHours()).slice(-2) + ("0" + date.getMinutes()).slice(-2) + ("0" + date.getSeconds()).slice(-2)
        ...
        if (this.state.deliveryOption === "Internet Banking") {
            await this.props.createPayment({ total: totalPrice, orderCode: orderCode, })
    ...
    renderBook = () => {
        let priceDiscounted = Math.round((this.props.book.price - this.props.book.price * this.props.book.discount) / 1000) * 1000;
    ...
    render() {
        return (
            ...
            >
                <DialogTitle sx={{ fontWeight: "700" }}>Payment Information</DialogTitle>
                <DialogContent>
                    <Box
                        noValidate
                        component="form"
                    ...
                    >
                        ...
                        <Stack sx={{
                            ...
                            <NumericFormat
                                value={this.props.book ? (this.props.total + this.state.transportFee + this.state.VAT) : this.props.total}
                                thousandsGroupStyle="thousands"
                                thousandSeparator=","
                                suffix={" VND"}
                                displayType="text"
                        ...
                        <Stack sx={{
                            ...
                            <FormControl size="small" color='success' sx={{ m: 1, width: { md: "80%", sm: "70%", xs: "60%" }, heigh: "20px" }}>
                                <InputLabel sx={{ fontSize: "14px" }} id="demo-simple-select-standard-label">Options</InputLabel>
                                <Select
                                    labelId="demo-simple-select-helper-label"
                                    id="demo-simple-select-helper"
                                    value={this.props.numberCart === 0 ? 0 : this.state.deliveryOption}
                                    onChange={(event) => {
                                        this.setState({
                        ...
                        <Stack sx={{
                            p: "1em",
                            width: "100%"
                        }} direction={{ md: "row", sm: "column" }} alignItems="flex-Start" justifyContent="space-between" spacing={1}>
                            <Typography
                                sx={{
                                    fontSize: "14px",
                                    fontWeight: 500,
                            ...
                            <Stack direction="column" sx={{ width: { md: "80%", sm: "100%", xs: "100%" } }}>
                ...
                <DialogActions>
                    ...
                    <Button variant="contained" color="error" onClick={this.props.onClose}>Close</Button>
                </DialogActions>
            </Dialog>
        )
    }
