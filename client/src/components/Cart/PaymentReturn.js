    ...
    return (
        <Container maxWidth="xl">
            <Box sx={{
                ...
                {
                    codeResponse === "00" ? (
                        <Stack direction="column" spacing={3} sx={{ width: "100%", height: "100%" }} justifyContent="center" alignItems='center'>
                            <CelebrationIcon sx={{
                                width: "100px",
                                height: "100px",
                            }}
                            ...
                            <Button onClick={() => history.push("/")} variant='contained' color='success'>Go on shopping</Button>
                        </Stack>
                    ) : (codeResponse === "97") ? (
                        <Stack direction="column" spacing={3} sx={{ width: "100%", height: "100%" }} justifyContent="center" alignItems='center'>
                            <CelebrationIcon sx={{
