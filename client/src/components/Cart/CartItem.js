import { Box, Button, ButtonGroup, IconButton, ListItem, ListItemText, Typography } from '@mui/material'
    ...
    return (
        <ListItem sx={{ borderBottom: "1px solid", mt: "0.5em", p: {xs: "0.5em"} }} alignItems="center">
            ...
            <Box sx={{   display: "flex", flexDirection: "column", alignItems: "center" }}>
                ...
                <ButtonGroup sx={{ mt: { sm: "1em", xs: "0.5em" }, }} variant="outline" color="success" size="small" >
