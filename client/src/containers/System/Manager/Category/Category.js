                                    ...
                                    arrCategory.map((item, index) => {
                                        return (
                                            <tr key={index}>
                                                ...
                                                <td>
                                                    <button onClick={() => this.handleEditCategory(item)} className="buttonEdit" >Edit</button>
                                                    <button onClick={() => this.handleDeleteCategory(item)} className="buttonDelete">Delete</button>
                                                </td>
                                            </tr>
                                        )
                                    })}
