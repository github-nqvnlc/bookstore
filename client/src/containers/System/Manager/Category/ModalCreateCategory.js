        ...
        return (
            <div>
                ...
                >
                    ...
                    <ModalFooter>
                        <Button className="btn_create" onClick={() => this.handleCreateCategory()}>
                            Create
                        </Button>
...
const mapDispatchToProps = (dispatch) => {
    return {
        createNewCategory: (data) => dispatch(actions.createCategory(data)),
    };
};
export default connect(mapStateToProps, mapDispatchToProps)(ModalCreateCategory);
