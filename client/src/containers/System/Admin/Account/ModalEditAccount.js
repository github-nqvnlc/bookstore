...
class ModalEditAccount extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (prevProps.editAccount !== this.props.editAccount) {
            ...
            if (account.image) {
                ...
                console.log("Check props image", account.image)
            }
            this.setState({
                id: account.id,
                email: account.email,
    ...
    render() {
        let { email, password, firstName, lastName, address, phoneNumber, gender, role, } = this.state;
            ...
            <div>
                            ...
                            <Row mt={3}>
                                ...
                                <Col md={3}>
                                    <FormGroup>
                                        ...
                                        >
                                            {
                                                selectRole && selectRole.length > 0 && selectRole.map((item, index) => {
                                                    return (
                                ...
                                <Col md={3}>
                                    ...
                                    <div className="py-2">
                                        <Label
                                            ...
                                            htmlFor="imageUpload"
                                        >Upload Image <i class="px-1 py-1 fa fa-upload"></i></Label>
                                        <Input
                                            type="file"
                                            id="imageUpload"
                ...
                </Modal>
                {
                    ...
                    <Lightbox
                        ...
                        onCloseRequest={() => { this.setState({ isOpen: false }); this.toggle() }}
