...
class Register extends Component {
    ...
    render() {
        //jsx
        let { email, password, confirm_password, firstName, lastName, address, phoneNumber, gender } = this.state;
                        ...
                        <div className="register_conntainer">
                            <div className="input_image">
                                <img
                                    ...
                                    src={this.state.previewUrlImage === '' ? avatar : this.state.previewUrlImage}
                            ...
                            <div className="form_group">
                                ...
                                >
                                    ...
                                    <div className="input_group" style={{ width: "50%" }}>
                                        ...
                                        <input
                                            type="Password"
                                            onChange={(e) => this.handleOnChangeInput(e, "confirm_password")}
